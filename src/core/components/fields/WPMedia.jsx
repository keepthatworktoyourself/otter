...
import PageDataContext from '../otter/Editor'
import ClearSelectionBtn from '../otter/other/ClearSelectionBtn'
            ...
            <div className="flex justify-start items-start">
              <div className="mr-4">
                <figure className="block relative w-24 h-24 mb-1 text-center border">
                  ...
                  {!value && (
                    <p className={theme_ctx.classes.typography.copy}>Nothing selected</p>
                  )}
                </figure>

                {file_name &&
                  <p className={classNames(theme_ctx.classes.typography.copy, 'ml-1')}>
                    {file_name}
                  </p>
                }
              </div>
              ...
              <div className="flex justify-start items-center">
                <a className="wpmedia-select inline-block mr-3"
